...
void mainTask(void *params){
	...
	worker4.start("Worker 5", TASK_PRIORITY + 4);
	worker4.start("Worker 6", TASK_PRIORITY + 5);
	worker4.start("Worker 7", TASK_PRIORITY + 6);
	worker4.start("Worker 8", TASK_PRIORITY + 7);
